    ...
    <>
      <div className='flex gap-4'>
        <button
          ...
          className='flex w-full items-center justify-center gap-2.5 rounded-lg p-3.5 hover:bg-white/10 bg-white/5 text-white cursor-pointer'>
          Sign In
          <svg
            width='23'
            height='22'
        ...
        <button
          ...
          className='flex w-full items-center justify-center gap-2.5 rounded-lg p-3.5 text-white hover:bg-white/10 bg-white/5 cursor-pointer'>
          Sign In
          <svg
            width='22'
            height='22'
