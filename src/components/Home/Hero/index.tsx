        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          <motion.div {...leftAnimation} className="flex flex-col gap-10">
            ...
            <div className="flex items-center md:justify-start justify-center gap-4">
              ...
              <a
                href="/signin"
                className="bg-transparent hover:bg-primary/10 flex items-center gap-2 border border-primary rounded-lg font-semibold text-primary py-3 px-7 cursor-pointer"
              >
                Sign In
              </a>
            </div>
