  ...
  return (
    <footer className='pt-16 bg-background'>
      <div className='container px-4'>
        ...
        <p className='text-white/40 text-center py-8 border-t border-white/10'>Design & Develop by <Link className='hover:text-primary' href={"https://getnextjstemplates.com/"}>GetNextjsTemplates.com</Link></p>
      </div>
    </footer>
  )
}
